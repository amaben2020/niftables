...
const HorizontalCard = ({ title, description, image }: THorizontalCards) => {
  return (
    <>
      <div className="min-w-full opacity-95 bg-black-quaternary md:bg-black-secondary grid md:grid-cols-3 relative md:h-[420px] xl:h-[310px] rounded-md overflow-hidden">
